# -*- coding: utf-8 -*-
"""
Created on Sat Jan 25 18:42:27 2025
...
# 加载数据
data = pd.read_excel(r"C:\Users\Lucius\Desktop\变量.xlsx")  # 替换为实际数据路径
...
full_data2028 = pd.read_excel(r"C:\Users\Lucius\Desktop\do file\2028_all.xlsx")
...
pred_2028 = pd.DataFrame({
    ...
    'year':2028,
    'pred_gold':y_pred_2028
    })


pred_2028.to_excel('pred_2028_all_gold.xlsx',index=False)
